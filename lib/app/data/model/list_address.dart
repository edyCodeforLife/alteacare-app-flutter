class ListAddress {
  ...
  factory ListAddress.fromJsonError(Map<String, dynamic> json) {
    return ListAddress(
      status: json["status"] as bool,
      message: json["message"] as String,
      data: Data.fromJson(json["data"] as Map<String, dynamic>),
  ...
  factory ListAddress.fromJsonErrorCatch(String json) {
    return ListAddress(
      message: json,
    );
  }
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        address: List<Address>.from((json["address"] as List)
