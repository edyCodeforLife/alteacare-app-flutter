...
class IOSCallScreen extends StatefulWidget {
  final String? callId;
  IOSCallScreen({required this.callId});

  @override
  _IOSCallScreenState createState() => _IOSCallScreenState();
}

class _IOSCallScreenState extends State<IOSCallScreen> with WidgetsBindingObserver {
                                                ...
                                                : Column(
                                                    ...
                                                    children: [
                                                      Container(
                                                        ...
                                                        child: InkWell(
                                                          onTap: () async {
                                                            // print(chats[idx].data());

                                                            // FirebaseStorage fbs =
                                                            //     FirebaseStorage
                                                            //         .instance;
                                                            // String url = await fbs
                                                            //     .ref(
                                                            //         'chatFiles/${chats[idx].data()['name']}')
                                                            //     .getDownloadURL();
                                                            // if (await canLaunch(
                                                            //     url)) {
                                                            //   await launch(url);
