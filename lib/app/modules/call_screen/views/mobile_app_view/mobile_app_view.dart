...
class _MobileAppCallScreenState extends State<MobileAppCallScreen> with WidgetsBindingObserver {
  ...
  Future<void> connectAndListenToSocket() async {
    ...
    try {
      socket?.io.options['query'] = 'method=CALL_MA&appointmentId=$_appointmentId';
    } catch (e) {
      print('error change options on SOCKET : $e');
    }
    print('SOCKET options : ${socket?.io.options}');
    // socket.disconnect();
    // socket.io.options = optionBuilderQuery!;
    // socket.query = '';

    try {
      socket?.connect();
      // print('SOCKET try ------ : ${socket?.opts}');
    } catch (e) {
  ...
  Future<void> setOptionBuilder() async {
    ...
    optionBuilderQuery = {
      "query": {'method': 'CALL_MA', 'appointmentId': _appointmentId},
  ...
  @override
  void initState() {
    print('call id => ${widget.callId}, appointment id : ${widget.appointmentId}');
    _appointmentId = konsultasiController.appointmentId.value;
    fToast = FToast();
    fToast.init(context);
          ...
          if (!closedByUser) {
            ...
            if (!(res.data() as Map)['name'].toString().contains('Doctor')) {
              ...
              if (callScreenController.isMeDisconnect.value) {
                ...
                Get.offNamed('/doctor-success-screen', arguments: formatTime(_stopwatch.elapsedMilliseconds));
              }
            }
  ...
  Future<Map<String, dynamic>> getDataConsultationDetail() async {
    ...
    try {
      final response = await http.get(
          Uri.parse(
            "${settings.alteaURL}/appointment/v1/consultation/${konsultasiController.appointmentId.value}",
          ),
  ...
  void initRoom() async {
    await connectAndListenToSocket();
    ...
    if (widget.callId != 'new' && widget.callId != 'doctor') {
      ...
      _fireStoreDataBase.collection('calls').doc().get().then((DocumentSnapshot documentSnapshot) {
      ...
      print('siap sini break point?');
      QuerySnapshot orders = await FirebaseFirestore.instance
          .collection('calls')
          .where(
            'orderId',
            isEqualTo: konsultasiController.appointmentId.value,
          )
          .get();
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    //     //
                                                    //     // }catch(e){
                                                    //     //   print("change video on camera picker error?? $e");
                                                    //     //
                                                    //     // }
                                                                  ...
                                                                  child: CustomFlatButton(
                                                                      ...
                                                                      onPressed: () async {
                                                                        if (widget.callId == 'doctor') {
                                                                          ...
                                                                          await closeCall(false);
                                                                          // print('doctorssss');
                                                                          Get.offNamed('/doctor-success-screen',
                                                                              arguments: formatTime(_stopwatch.elapsedMilliseconds));
                                                                          // Get.back();
                                                                        } else {
                                                                          // print('maaaaaaaaaa');
                                                  ...
                                                  child: Stack(
                                                    children: [
                                                      Container(
                                                          color: Colors.black87.withOpacity(0.7),
                                                          child: Center(
                                                              child: Text("Anda sedang membagikan layar Anda",
                                                                  style: kPoppinsMedium500.copyWith(color: Colors.grey, fontSize: 14)))
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      ...
                                                      child: Text(
                                                        ...
                                                        style: kDialogSubTitleStyle.copyWith(fontSize: 14),
                                                      ),
                                                    ),
                                                    const SizedBox(
                                                      height: 16,
