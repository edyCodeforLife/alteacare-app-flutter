...
class DekstopWebViewArticle extends GetView<ArticleController> {
  const DekstopWebViewArticle({Key? key}) : super(key: key);
                          ...
                          children: [
                            Expanded(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: Image.network(addCDNforLoadImage(controller.listPopularArticle[0].image!), fit: BoxFit.cover)),
                            ),
                            SizedBox(
                              width: screenWidth * 0.01,
                            ),
                            ...
                            (index) => Container(
                              child: Column(
                                ...
                                children: [
                                  SizedBox(
                                    height: 150,
                                    child: Image.network(addCDNforLoadImage(controller.listAllArticleNewAndPopular[index].image!), fit: BoxFit.cover),
                                  ),
                                  SizedBox(
                                    height: screenWidth * 0.01,
                                  ),
                                          ...
                                          .map(
                                            (tag) => Padding(
                                              ...
                                              child: Container(
                                                ...
                                                decoration:
                                                    BoxDecoration(borderRadius: BorderRadius.circular(16), color: kButtonColor.withOpacity(0.2)),
                                                child: Text(tag.name!,
                                                    style: kTextInputStyle.copyWith(color: kButtonColor, fontSize: 12, fontWeight: FontWeight.w500)),
                                              ),
                                            ),
                                          )
                                          .toList()),
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text(
                                      ...
                                      style: kTextInputStyle.copyWith(color: kBlackColor, fontSize: 15, fontWeight: FontWeight.w500),
                                      maxLines: 2,
