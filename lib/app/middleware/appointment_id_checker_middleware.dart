...
class AppointmentIdCheckerMiddleware extends GetMiddleware {
  @override
  int? get priority => 3;
  ...
  RouteSettings? redirect(String? route) {
    if (GetPlatform.isWeb) {
      final String appointmentId = Get.parameters.containsKey("appointmentId") ? Get.parameters['appointmentId'].toString() : "";
